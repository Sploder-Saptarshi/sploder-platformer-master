...
package com.sploder.asui {
	...
	public class Key extends EventDispatcher {
        ...
        public static function charIsDown(char:String):Boolean {
            ...
            return Boolean((char.charCodeAt(0) in keysDown) || (char.toUpperCase().charCodeAt(0) in keysDown));
        ...
        private static function keyReleased(event:KeyboardEvent):void {
			...
			if (event.shiftKey) _shiftDown = false;
			if (event.ctrlKey) _ctrlDown = false;
