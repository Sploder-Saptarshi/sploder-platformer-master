...
package fuz2d.library {
	...
	import com.adobe.serialization.json.JSONold;
					...
					switch (objType) {
						...
						case "tile":
							...
							if (dnaobj.children()[0] != undefined && dnaobj.children()[0].toString().length > 0) {
								defID = Fuz2d.library.createTileSet(tid, back, com.adobe.serialization.json.JSONold.decode(dnaobj.children()[0].toString()), -1, tilescale)
								dna.obj.@defID = defID;
						...
						case "sim":
							...
							if (collisionObjType == CollisionObject.POLYGON || collisionObjType == CollisionObject.POLYGON2) {
								...
								if (ObjectFactory.cache[dna.@id + "_vertices"] != null) {
									...
									nodeData = com.adobe.serialization.json.JSONold.decode(nodeString) as Array;
