...
package fuz2d.action.animation {
	...
	import fuz2d.action.animation.Tween;
	...
	public class TweenManager {
		...
		public function update (e:Event):void {
			...
			_currentTime = TimeStep.realTime;
		...
		//
		//
		public function createTween (tweenObject:Object, attribute:String, startVal:Number = NaN, endVal:Number = NaN, duration:Number = 1, loop:Boolean = false, yoyo:Boolean = false, loops:int = 0, delay:Number = 0, easeType:Number = 0, easeStyle:Number = 0, startHandler:Function = null, doneHandler:Function = null, groupID:int = 0):int {
			
			if (groupID == 0) advanceGroupID();
			
			removeTweenOnObjectWithAttribute(tweenObject, attribute);
		...
		//
		//
		public function createTweens (tweenObjects:Array, startVals:Object, endVals:Object, duration:Number = 1, loop:Boolean = false, yoyo:Boolean = false, loops:int = 0, delay:Number = 0, easeType:Number = 0, easeStyle:Number = 0, startHandler:Function = null, doneHandler:Function = null):int {
		...
		public function start ():void {
			View.mainStage.addEventListener(Event.ENTER_FRAME, update, false, 2);
		}
